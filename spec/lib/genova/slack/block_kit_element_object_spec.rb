    ...
    describe BlockKitElementObject do
      ...
      describe 'repository_options' do
        it 'should be return repositories' do
          results = Genova::Slack::BlockKitElementObject.repository_options
      ...
      describe 'branch_options' do
        ...
        it 'should be return brahches' do
          ...
          results = Genova::Slack::BlockKitElementObject.branch_options('account', 'repository')
          expect(results.count).to eq(1)
        end
      end
      ...
      describe 'tag_options' do
        ...
        it 'should be return tags' do
          ...
          results = Genova::Slack::BlockKitElementObject.tag_options('account', 'repository')
          expect(results.count).to eq(1)
        end
      end
      ...
      describe 'cluster_options' do
        ...
        it 'should be return clusters' do
          ...
          results = Genova::Slack::BlockKitElementObject.cluster_options('account', 'repository', 'branch', 'tag', 'base_path')
      ...
      describe 'target_options' do
        ...
        it 'should be return targets' do
          ...
          results = Genova::Slack::BlockKitElementObject.target_options('account', 'repository', 'branch', 'tag', 'cluster', 'base_path')
